 ...
 */
public class DarkGrayCastleMiddleTile {

    public BufferedImage getAssociatedSpriteSheet(){
        return CastleFortressSpriteSheet.getSpriteSheet();
    }
    ...
    public int dy2;
    public int getDy2(){return y + width;}
    public void setDy2(int dy2){this.dy2 = dy2;}

    //69, 18 --- 84 , 33
    public DarkGrayCastleMiddleTile(int x, int y, int width, int height){
